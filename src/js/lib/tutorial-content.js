...
export const TUTORIALS = {
  ...
  dashboard: {
    ...
    tagline: 'Sua central de controle financeiro em tempo real.',
    ...
    sections: [
      {
        ...
        body: `O Dashboard é a primeira tela que você vê ao entrar no FinFlow. Ele reúne os dados mais importantes das suas finanças em um só lugar, sem precisar navegar por outras telas.
...
Pense nele como o painel de instrumentos do seu carro — você não precisa abrir o capô para saber a velocidade e o nível de combustível.`,
      ...
      {
        title: 'KPIs do mês',
        body: `Na parte superior, você encontra os indicadores-chave do mês atual:
...
Se houver pagamentos atrasados, um alerta vermelho aparece logo abaixo dos KPIs.`,
      },
      {
        ...
        body: `O Dashboard é montado com widgets que você pode reorganizar e ocultar. Os widgets disponíveis são:
...
• <strong>Atalhos rápidos</strong> — Botões de acesso direto às telas mais usadas.`,
      ...
      {
        title: 'Como personalizar o Dashboard',
        body: `Clique no botão <strong>"Personalizar"</strong> no canto superior direito para entrar no modo de edição.
...
Suas preferências são salvas automaticamente.`,
      ...
      {
        title: 'Como o Dashboard se conecta com outras telas',
        body: `O Dashboard é somente leitura — ele consome dados, mas não cria nada. Suas conexões:
...
• Os atalhos rápidos levam para Pagamentos, Orçamento, Compromissos e Relatórios.`,
    ...
    tips: [
      'Deixe os widgets que você mais usa no topo — os indicadores BCB e câmbio são ótimos para quem tem investimentos no exterior.',
      'O saldo realizado só inclui o que foi <strong>pago/recebido</strong>. Para ver o planejado, acesse Pagamentos.',
      'Use os atalhos rápidos como ponto de partida do seu dia financeiro.',
    ],
  },
  ...
  contas: {
    ...
    tagline: 'Bancos, cartões e carteiras — a base de tudo no FinFlow.',
    ...
    sections: [
      {
        title: 'Por que começar pelas Contas?',
        body: `Contas é o cadastro fundamental do FinFlow. Antes de lançar qualquer compromisso, pagamento ou transação, você precisa cadastrar os bancos, cartões e carteiras que usa.
...
Tudo no sistema é vinculado a uma conta: de onde o dinheiro sai, para onde vai, qual cartão foi usado.`,
      },
      {
        ...
        body: `Clique em <strong>"+ Nova conta"</strong> para abrir o formulário. Preencha:
...
• <strong>Desde</strong> — Data de abertura da conta (obrigatório).`,
      ...
      {
        title: 'Configurações exclusivas de Cartão de Crédito',
        body: `Ao selecionar o tipo <strong>Cartão de Crédito</strong>, dois campos extras aparecem:
...
Esses dados alimentam a seção de Faturas e os indicadores de comprometimento.`,
      ...
      {
        title: 'Visualizações: cards e tabela',
        body: `Use os botões de toggle no canto superior para alternar entre:
...
Os <strong>filtros de status</strong> (Todas / Ativas / Inativas / Arquivadas) e os <strong>filtros de tipo</strong> ficam acima das listas.`,
      ...
      {
        title: 'Detalhes e ações em uma conta',
        body: `Clique em qualquer conta para abrir o modal de detalhes. Lá você encontra:
...
Uma conta arquivada não aparece nos seletores das outras telas, mas o histórico é preservado.`,
      ...
      {
        title: 'Como Contas se conecta com outras telas',
        body: `Contas é referenciada em praticamente todas as outras telas:
...
• <strong>Importar extrato</strong> — Você seleciona a conta destino dos lançamentos.`,
    ...
    tips: [
      'Cadastre <strong>todas</strong> as suas contas antes de começar a usar o sistema — isso evita retrabalho.',
      'Use apelidos descritivos: "Bradesco Salário", "C6 Viagens", "Caixa Fundo Emergência".',
      'Ao encerrar uma conta bancária, use <strong>Arquivar</strong> em vez de deletar — isso preserva o histórico.',
      'O badge de comprometimento no card aparece automaticamente quando você cadastra o limite e tem compromissos ativos no cartão.',
    ],
  },
  ...
  compromissos: {
    ...
    category: 'cadastros',
    categoryLabel: 'Cadastros',
    tagline: 'O coração do planejamento: suas receitas e despesas recorrentes.',
    ...
    sections: [
      {
        title: 'O que são Compromissos?',
        body: `Compromissos são a espinha dorsal do FinFlow. Eles representam tudo que entra ou sai do seu bolso de forma recorrente: salário, aluguel, assinaturas, parcelas, transferências automáticas.
...
• <strong>Transferência</strong> — Movimentação entre suas próprias contas. Você define a conta de origem e a conta de destino.`,
      },
      {
        ...
        body: `Clique em <strong>"+ Novo compromisso"</strong>. Os campos principais são:
...
• <strong>Início / Término</strong> — Período de vigência.`,
      },
      {
        ...
        body: `Se um compromisso não tem valor fixo (ex: conta de luz), marque a opção <strong>"Valor variável"</strong>.
...
Essa configuração é ideal para contas sazonais que variam ao longo do ano.`,
      ...
      {
        title: 'Indicador de limite comprometido',
        body: `Quando você vincula um compromisso a um <strong>Cartão de Crédito</strong> que tem limite cadastrado, o sistema exibe automaticamente:
...
Isso ajuda a evitar comprometer demais o limite do cartão com despesas fixas.`,
      ...
      {
        title: 'Duplicar um compromisso',
        body: `No modal de detalhes, clique em <strong>"Duplicar"</strong> para criar uma cópia pré-preenchida do compromisso.
...
Útil para criar variações de um compromisso existente (ex: versão em outra moeda, outro banco).`,
      },
      {
        ...
        body: `Ao selecionar o tipo <strong>Transferência</strong>, dois campos de conta aparecem:
...
Use para registrar aportes automáticos em poupança, transferência entre bancos, ou qualquer movimentação interna.`,
      ...
      {
        title: 'Como Compromissos se conecta com outras telas',
        body: `Compromissos é o módulo mais central do FinFlow:
...
• <strong>← Configurações</strong> — As categorias disponíveis vêm de Configurações → Categorias.`,
    ...
    tips: [
      'Configure seus compromissos com precisão — eles são o planejamento, e Pagamentos é a execução.',
      'Use a <strong>Periodicidade "Único"</strong> para lançamentos pontuais que ainda não viraram transações.',
      'Vincule compromissos de dívida a uma <strong>Dívida</strong> para ver o progresso de quitação automaticamente.',
      'O campo <strong>Apelido</strong> aparece no lugar do nome nas listagens — use para nomes mais curtos e claros.',
    ],
  },
  ...
  pagamentos: {
    ...
    tagline: 'A execução mensal do seu orçamento — marque, controle, acompanhe.',
    ...
    sections: [
      {
        title: 'O que é a tela de Pagamentos?',
        body: `Pagamentos é onde você opera o dia a dia financeiro. Se Compromissos é o seu orçamento planejado, Pagamentos é a lista de tarefas de cada mês.
...
O sistema gera automaticamente uma entrada para cada compromisso ativo, organizada por blocos quinzenais.`,
      },
      {
        ...
        body: `Use as setas <strong>◀ ▶</strong> para navegar entre meses, ou clique em <strong>"Hoje"</strong> para voltar ao mês atual.

O mês exibido no topo é o período de referência de todas as entradas da lista.`,
      },
      {
        title: 'Blocos quinzenais',
        body: `Os pagamentos são organizados em dois blocos:
...
Cada bloco exibe um resumo de Receitas, Despesas e Saldo. Use o botão <strong>"Regenerar blocos"</strong> se mudou sua renda principal e precisa recalcular.`,
      },
      {
        ...
        body: `Cada entrada pode ter um dos seguintes status:
...
Clique no status atual de qualquer entrada para alterá-lo diretamente na lista.`,
      ...
      {
        title: 'Registrar valor real pago',
        body: `Quando um pagamento tem valor diferente do planejado, abra os detalhes da entrada e informe o <strong>valor real pago</strong>.

O sistema usa esse valor nos relatórios de Previsto vs. Real, permitindo análises precisas de desvio orçamentário.`,
      },
      {
        title: 'Pagamento parcial',
        body: `Ao marcar um pagamento como <strong>Parcial</strong>:
...
Ideal para parcelamentos informais ou pagamentos em aberto.`,
      },
      {
        ...
        body: `Use os filtros no topo para ver apenas o que precisa de atenção:
...
• <strong>Cancelados</strong> — Entradas descartadas.`,
      ...
      {
        title: 'Como Pagamentos se conecta com outras telas',
        body: `• <strong>← Compromissos</strong> — Os lançamentos são gerados a partir dos compromissos ativos.
...
• <strong>← Categorias</strong> — Os blocos são organizados pelas categorias de Configurações.`,
    ...
    tips: [
      'Crie o hábito de abrir Pagamentos uma vez por semana e marcar o que foi executado.',
      'Use o filtro <strong>"Atrasados"</strong> para nunca deixar passar uma conta vencida.',
      'O campo <strong>Observação</strong> em cada entrada é útil para anotar número de protocolo, comprovante ou nota.',
      'Navegue para meses futuros para ter uma prévia do que está programado.',
    ],
  },
  ...
  transacoes: {
    ...
    category: 'operacional',
    categoryLabel: 'Operacional',
    tagline: 'Registre movimentações reais e mantenha seu extrato reconciliado.',
    ...
    sections: [
      {
        title: 'Transações vs. Pagamentos — qual a diferença?',
        body: `<strong>Compromissos → Pagamentos</strong> é o fluxo de <em>planejamento</em>: você define o que precisa pagar/receber e marca quando executa.
...
Para um controle completo, os dois se complementam: Pagamentos mostra o que foi planejado; Transações comprova o que ocorreu.`,
      ...
      {
        title: 'KPIs de período',
        body: `No topo da tela, quatro indicadores mostram o total do período selecionado:
...
O período é controlado pelos filtros de data (Mês, Ano, Período livre ou Todos).`,
      },
      {
        ...
        body: `Clique em <strong>"+ Nova transação"</strong>. Campos principais:
...
• <strong>Descrição</strong> — Anotação livre.`,
      },
      {
        ...
        body: `Acima da lista, vários filtros ajudam a encontrar transações específicas:
...
As colunas visíveis podem ser ajustadas pelo seletor no canto da tabela.`,
      ...
      {
        title: 'Reconciliação',
        body: `Reconciliar significa confirmar que a transação registrada no FinFlow bate com o extrato real do banco.
...
Use o filtro <strong>"Pendentes"</strong> para ver só o que ainda não foi conferido.`,
      ...
      {
        title: 'Ações em lote',
        body: `Marque múltiplas transações usando os checkboxes da primeira coluna. Com itens selecionados, uma barra de ações aparece para <strong>deletar em lote</strong>.

Útil para limpar importações erradas ou apagar transações duplicadas.`,
      },
      {
        title: 'Como Transações se conecta com outras telas',
        body: `• <strong>← Contas</strong> — Toda transação é vinculada a uma conta.
...
• <strong>← Importar</strong> — A importação de extrato cria transações em lote nesta tela.`,
    ...
    tips: [
      'Vincule a Subcategoria sempre que possível — isso enriquece os relatórios de Previsto vs. Real.',
      'Para quem usa importação de extrato, o trabalho em Transações é principalmente revisar e categorizar os lançamentos importados.',
      'Reconcilie semanalmente para manter o controle em dia.',
    ],
  },
  ...
  contatos: {
    ...
    category: 'cadastros',
    categoryLabel: 'Cadastros',
    tagline: 'Clientes, fornecedores e o motor de reconhecimento automático de extrato.',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>`,
    color: '#EC4899',
    sections: [
      {
        title: 'O que são Contatos?',
        body: `Contatos é o cadastro de pessoas e empresas com quem você tem relacionamento financeiro: patrões, locadores, lojas, assinaturas, fornecedores de serviços.

Além de organizar quem é quem, os contatos têm um superpoder: o <strong>reconhecimento automático de extrato</strong>.`,
      },
      {
        title: 'Layout em dois painéis',
        body: `A tela usa um layout dividido:
...
Clique em qualquer contato na lista para ver seus detalhes no painel direito.`,
      ...
      {
        title: 'Criando um contato',
        body: `Clique em <strong>"+ Novo contato"</strong>. Campos:
...
• <strong>Observação</strong> — Anotação livre.`,
      ...
      {
        title: 'Reconhecimento automático de extrato',
        body: `A aba <strong>"Reconhecimento"</strong> mostra os padrões de texto do extrato aprendidos para este contato.
...
O campo <strong>"Nome no extrato"</strong> é o principal gatilho: coloque o trecho de texto que aparece no seu extrato bancário para aquele fornecedor.`,
      },
      {
        ...
        body: `A aba <strong>"Transações"</strong> mostra todas as movimentações registradas vinculadas a este contato.
...
Útil para ver o histórico completo de pagamentos para um fornecedor ou recebimentos de um cliente.`,
      },
      {
        ...
        body: `Um contato <strong>não pode ser excluído</strong> se estiver vinculado a compromissos ou transações.
...
O sistema exibe uma mensagem informando quantos registros estão vinculados. Para remover o contato, primeiro desvincule-o de todos os registros, ou use <strong>Arquivar</strong> para desativá-lo sem perder o histórico.`,
      ...
      {
        title: 'Como Contatos se conecta com outras telas',
        body: `• <strong>← Compromissos</strong> — Campo "Cliente / Fornecedor" no formulário de compromisso.
...
• <strong>← Importar</strong> — O reconhecimento automático sugere o contato ao importar o extrato.`,
    ...
    tips: [
      'Preencha o <strong>Nome no extrato</strong> com o texto exato do seu banco — copie e cole do extrato para evitar erros.',
      'Cadastre fornecedores recorrentes antes de importar extratos para aproveitar o reconhecimento automático.',
      'Use o tipo <strong>"Ambos"</strong> para contatos que às vezes pagam e às vezes recebem.',
    ],
  },
  ...
  dividas: {
    ...
    category: 'cadastros',
    categoryLabel: 'Cadastros',
    tagline: 'Acompanhe o progresso de cada dívida em direção à quitação.',
    ...
    sections: [
      {
        title: 'O que é a tela de Dívidas?',
        body: `Dívidas centraliza o controle de empréstimos, financiamentos e qualquer obrigação financeira de médio ou longo prazo.

Você registra o total da dívida, os pagamentos mensais e acompanha visualmente o progresso até a quitação.`,
      },
      {
        title: 'KPIs de dívidas',
        body: `No topo da tela, dois indicadores resumem sua situação:
...
• <strong>Total pago</strong> — Soma de todos os pagamentos registrados.`,
      ...
      {
        title: 'Criando uma dívida',
        body: `Clique em <strong>"+ Nova dívida"</strong>:
...
• <strong>Contato</strong> — Credor cadastrado em Contatos.`,
      ...
      {
        title: 'Registrando um pagamento',
        body: `Nos detalhes de uma dívida, use o botão <strong>"Registrar pagamento"</strong> para adicionar um abatimento.
...
O sistema mostra o valor total, o já pago e o saldo restante. Cada registro atualiza a barra de progresso.`,
      },
      {
        ...
        body: `• <strong>Cards</strong> — Cada dívida como um card com barra de progresso visual.
...
As dívidas são agrupadas em: <strong>Em progresso</strong>, <strong>Por começar</strong> e <strong>Terminado</strong>.`,
      ...
      {
        title: 'Como Dívidas se conecta com outras telas',
        body: `• <strong>← Compromissos</strong> — Ao criar um compromisso de despesa para pagar uma dívida mensalmente, você pode vincular o campo "Dívida vinculada". Isso registra automaticamente os pagamentos mensais no progresso da dívida.
• <strong>← Contas</strong> — A conta vinculada vem do cadastro de Contas.
...
• <strong>→ Configurações</strong> — Dívidas aparecem como vínculo em Configurações → Categorias.`,
    ...
    tips: [
      'Crie um <strong>Compromisso de despesa</strong> para cada parcela mensal e vincule-o à dívida correspondente — o progresso será atualizado automaticamente.',
      'Use o status <strong>"Negociando"</strong> para dívidas em processo de renegociação.',
      'A visualização <strong>Gantt</strong> ajuda a planejar quitações quando você tem múltiplas dívidas simultâneas.',
    ],
  },
  ...
  investimentos: {
    ...
    category: 'cadastros',
    categoryLabel: 'Cadastros',
    tagline: 'Defina seus projetos e acompanhe o progresso rumo às suas metas.',
    ...
    sections: [
      {
        title: 'O que são Projetos de Investimento?',
        body: `Investimentos no FinFlow são metas financeiras — projetos concretos que você quer realizar: viagem, aposentadoria, reserva de emergência, compra de imóvel, fundo de estudo.

Você define um valor alvo e uma data, e o sistema acompanha automaticamente quanto já foi aportado.`,
      },
      {
        title: 'KPIs de investimentos',
        body: `No topo da tela:
...
• <strong>Projetos com meta</strong> — Quantidade de projetos que têm um valor-alvo definido.`,
      },
      {
        ...
        body: `Clique em <strong>"+ Novo projeto"</strong>:
...
• <strong>Saldo inicial</strong> — Se você já tem algo investido antes de começar a usar o FinFlow.`,
      },
      {
        ...
        body: `O progresso de um projeto é calculado automaticamente:
...
Assim, cada aporte confirmado avança automaticamente a barra de progresso.`,
      ...
      {
        title: 'Visualizações disponíveis',
        body: `• <strong>Cards</strong> — Cada projeto com barra de progresso, percentual alcançado e valor realizado vs. meta.
...
Agrupamento: <strong>Em progresso</strong>, <strong>Por começar</strong>, <strong>Terminado</strong>.`,
      ...
      {
        title: 'Como Investimentos se conecta com outras telas',
        body: `• <strong>← Compromissos</strong> — O campo "Projeto de investimento" em um compromisso vincula os aportes mensais ao projeto.
...
• <strong>→ Configurações</strong> — Projetos aparecem como vínculo em Configurações → Categorias.`,
    ...
    tips: [
      'Crie um compromisso de aporte mensal para cada projeto e vincule-o ao projeto — o progresso atualiza sozinho ao marcar como pago.',
      'Use o <strong>Saldo inicial</strong> para registrar o que você já tem investido antes de começar no FinFlow.',
      'Projetos <strong>Concluídos</strong> ainda aparecem no histórico — você pode ver quanto levou para atingir a meta.',
    ],
  },
  ...
  relatorios: {
    ...
    tagline: 'Analise seu histórico financeiro com gráficos e exportações.',
    ...
    sections: [
      {
        title: 'O que você encontra em Relatórios?',
        body: `Relatórios é o módulo de análise do FinFlow. Ele consolida dados de Transações e Pagamentos em gráficos e tabelas, com opção de exportação.

Três relatórios estão disponíveis, cada um respondendo a uma pergunta diferente sobre suas finanças.`,
      },
      {
        title: 'Filtro de período',
        body: `No topo, selecione o período de análise:
...
O filtro se aplica a todos os três relatórios simultaneamente.`,
      ...
      {
        title: 'Relatório 1: Fluxo de Caixa',
        body: `Responde à pergunta: <em>"Quanto entrou e quanto saiu ao longo do tempo?"</em>
...
Útil para ver tendências de meses ou anos anteriores.`,
      ...
      {
        title: 'Relatório 2: Previsto vs. Real',
        body: `Responde à pergunta: <em>"O que eu planejei gastar vs. o que realmente gastei?"</em>
...
O "previsto" vem dos Compromissos; o "realizado" vem dos Pagamentos marcados como pagos.`,
      ...
      {
        title: 'Relatório 3: Categorias',
        body: `Responde à pergunta: <em>"Onde estou gastando mais?"</em>
...
Essencial para identificar onde está indo o seu dinheiro.`,
      ...
      {
        title: 'Exportação',
        body: `Cada relatório pode ser exportado em três formatos:
...
Os botões de exportação ficam no canto superior direito de cada relatório.`,
      ...
      {
        title: 'Como Relatórios se conecta com outras telas',
        body: `Relatórios é uma tela de leitura pura — ela não cria nem edita dados. Consome:
...
Para que os relatórios sejam precisos, mantenha Transações e Pagamentos atualizados.`,
    ...
    tips: [
      'Use <strong>Previsto vs. Real</strong> mensalmente para ver se seu orçamento está sendo respeitado.',
      'O relatório <strong>Categorias</strong> com período "Ano" revela padrões anuais de gastos que não aparecem na visão mensal.',
      'Exporte para <strong>Excel</strong> para fazer análises personalizadas fora do FinFlow.',
    ],
  },
  ...
  configuracoes: {
    ...
    tagline: 'Categorias, aparência, moedas — personalize o FinFlow para você.',
    ...
    sections: [
      {
        title: 'Por que acessar Configurações primeiro?',
        body: `Antes de lançar compromissos e transações, configure suas <strong>categorias</strong>. As categorias são a estrutura de classificação do FinFlow — sem elas, os relatórios de Previsto vs. Real e de Categorias ficam genéricos.

O sistema cria algumas categorias padrão (Receitas, Dívidas, Investimentos), mas você pode personalizar à vontade.`,
      },
      {
        title: 'Aba Categorias',
        body: `Aqui você gerencia a hierarquia de categorias:
...
Cada categoria tem um <strong>bloco</strong> (Contribuição, Sonhos, Custo de Vida) e uma cor para identificação visual nos gráficos.`,
      ...
      {
        title: 'Vínculos de categorias',
        body: `A coluna <strong>"Vínculo"</strong> na tabela de categorias mostra se uma subcategoria está ligada a um projeto de Investimento ou a uma Dívida.
...
Esses vínculos são criados automaticamente quando você relaciona um compromisso a um projeto ou dívida. Clique no badge de vínculo para ir direto ao projeto ou dívida correspondente.`,
      ...
      {
        title: 'Aba Contatos',
        body: `A aba Contatos em Configurações oferece o mesmo gerenciamento que a tela dedicada de Contatos — você pode criar, editar e gerenciar contatos sem sair das Configurações.`,
      },
      {
        title: 'Aba Aparência',
        body: `Escolha o tema visual do FinFlow:
...
Também é possível configurar o <strong>idioma</strong> da interface (Automático, Português, English, Español).`,
      ...
      {
        title: 'Aba Moedas',
        body: `Configure as moedas que você usa:
...
Apenas as moedas ativadas aparecem nos seletores de moeda pelo sistema.`,
      ...
      {
        title: 'Como Configurações se conecta com outras telas',
        body: `Configurações alimenta todo o restante do sistema:
...
• <strong>→ Aparência</strong> — Tema e idioma aplicam-se globalmente.`,
    ...
    tips: [
      'Configure as categorias <strong>antes</strong> de começar a lançar compromissos — reorganizar depois é trabalhoso.',
      'Use cores diferentes para categorias principais — elas aparecem nos gráficos de Relatórios e ficam mais fáceis de identificar.',
      'A opção de tema <strong>"Automático"</strong> é a mais conveniente para quem usa o FinFlow em múltiplos dispositivos.',
    ],
  },
  ...
  importar: {
    ...
    category: 'operacional',
    categoryLabel: 'Operacional',
    tagline: 'Importe seu extrato bancário e categorize em segundos.',
    ...
    sections: [
      {
        title: 'O que é a importação de extrato?',
        body: `Em vez de lançar cada transação manualmente, você exporta o extrato do seu banco (em CSV, TXT, Excel ou OFX) e importa diretamente no FinFlow.

O assistente de importação tem 3 etapas: seleção do arquivo e conta, mapeamento de colunas, e revisão antes de importar.`,
      },
      {
        title: 'Etapa 1 — Arquivo e conta',
        body: `• <strong>Selecione o arquivo</strong> — Arraste para a área indicada ou clique para buscar. Formatos aceitos: CSV, TXT, XLSX, XLS, ODS.
...
Após selecionar, o sistema exibe o nome do arquivo e o número de linhas detectadas.`,
      ...
      {
        title: 'Etapa 2 — Mapeamento de colunas',
        body: `O sistema exibe uma prévia das primeiras linhas do arquivo. Configure:
...
• <strong>Formato de data</strong> — DD/MM/AAAA, MM/DD/AAAA ou AAAA-MM-DD (auto-detectado).`,
      ...
      {
        title: 'Etapa 3 — Revisão e importação',
        body: `A prévia mostra todas as transações parseadas com colunas:
...
As transações importadas aparecem imediatamente em Transações com status "importado".`,
      ...
      {
        title: 'Reconhecimento automático na importação',
        body: `Se você tem <strong>Contatos</strong> cadastrados com "Nome no extrato" preenchido, o sistema compara cada descrição importada e sugere automaticamente:
...
Quanto mais você usa o sistema e mantém os contatos atualizados, mais preciso fica o reconhecimento.`,
      ...
      {
        title: 'Como Importar se conecta com outras telas',
        body: `• <strong>← Contas</strong> — Você seleciona a conta destino dos lançamentos.
...
• <strong>→ Transações</strong> — Lançamentos importados aparecem na tela de Transações.`,
    ...
    tips: [
      'A maioria dos bancos brasileiros oferece exportação em CSV no aplicativo ou site — procure por "Exportar extrato" ou "Baixar histórico".',
      'Importe por períodos curtos (1 mês) para facilitar a revisão antes de importar.',
      'Após importar, vá para Transações e categorize os lançamentos sem subcategoria — isso melhora os relatórios.',
    ],
  },
...
export const CATEGORIES = {
  'visao-geral':  { label: 'Visão Geral',  color: '#6D5EF5' },
  'cadastros':    { label: 'Cadastros',    color: '#3B82F6' },
  'operacional':  { label: 'Operacional',  color: '#F59E0B' },
  'analise':      { label: 'Análise',      color: '#F97316' },
  'configuracao': { label: 'Configuração', color: '#6B7280' },
};
